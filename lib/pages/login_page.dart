            ...
            child: Padding(
              ...
              child: Column(  
                children: [ 
                  ...
                  SizedBox(height: 5,),
                  Text(AppStrings.logintoContinue, style: TextStyle(  
                    fontSize: 16,
                  color: Colors.white
                  ),), 
                   SizedBox(height: 30,),
                   ...
                   LoginSignupText(
                    ...
                    SizedBox(height:16),
                     Align(
                      ...
                      child: TextButton(onPressed: (){ print("Forgot is clicked");}, 
                     ...
                     SizedBox(height: 62),
                    TextButton(onPressed: (){print("other opt clicked");}, 
                    style:  TextButton.styleFrom(  
                    foregroundColor: Colors.white,
                    ),
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(onPressed: (){print("Google is clicked");},
                          ...
                          Row(
                            ...
                            children: [
                             Image.asset(AppIcons.ic_google,  
                            height: 25, width: 25,             
                            ),
                          ...
                          children: [  
                           const Text(AppStrings.donthaveAccount,
                            ...
                            TextButton(   onPressed: (){
                             Navigator.of(context).pushNamed(AppStrings.registration);
                              },
                              style:  TextButton.styleFrom(  
                              foregroundColor: Colors.white,
                                ),
