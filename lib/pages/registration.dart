                    ...
                    color: Colors.white,
                      ...
                      SizedBox(height: 50),
                       // AppTextField(hintText: AppStrings.username, secure: false ),
                        //SizedBox(height: 16,),
                        AppTextField(hintText: AppStrings.email , secure: false),
                        SizedBox(height: 16,),
                      //  AppTextField(hintText: AppStrings.phoneNumber, secure: false ),
                      // SizedBox(height: 16,),
                        AppTextField(hintText: AppStrings.password , secure: true),
                        SizedBox(height: 16,),
                        AppTextField(hintText: AppStrings.cnfrmpswd , secure: true ),
                        SizedBox(height: 32,),
                        SizedBox(
                      height: 48, width: 250,
